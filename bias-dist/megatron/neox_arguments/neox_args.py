...
class NeoXArgsModel(NeoXArgsTemplate):
    ...
    BiasNet args
    """
    use_BiasNet: bool = True
    experts_embedding: bool = True
    # process_dim: int = 896
    # hypernet_input: int = 128
    hypernetwork_bottleneck_dim: int = 128
    lora_rank: int = 1

    # layer_emb_dim: int = 10
    # adapter_dim: int = 64
    #experts_embedding_dim: int = 64
...
class NeoXArgsMoE(NeoXArgsTemplate):
    ...
    """
    moe_lora_alpha: float = 1.0
    hn_lora_rank: int = 1
    hn_scalar: int = 1
    per_expert_hn: bool = False
    hn_skip_cycle: int = 1
    hn_skip_grad: int = 1
    hn_start_cycle: int = 1
    hn_use_svd: bool = False
    hn_use_qr: bool = False