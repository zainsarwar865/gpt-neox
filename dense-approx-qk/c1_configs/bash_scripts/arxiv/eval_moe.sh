...
export HF_HOME="/fsx-claim/sambits_interns_2024/data/eval_harness_tasks_data_vox781/"
export FSX_EVAL_DATASET_PATH="/fsx-claim/sambits_interns_2024/data/eval_harness_tasks_data_vox781/"
export DATA_PATH="/fsx-claim/sambits_interns_2024/data/eval_harness_tasks_data_vox781/"
export data_path="/fsx-claim/sambits_interns_2024/data/eval_harness_tasks_data_vox781/"
...
# working tasks
# hellaswag ARC-Challenge ARC-Easy boolq copa openbookqa piqa sciq winogrande_xl winogrande lambada_standard
