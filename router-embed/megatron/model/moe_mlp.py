...
class ParallelBiasNetMLP(torch.nn.Module):
    def __init__(
        ...
        self.hidden_size = neox_args.hidden_size + neox_args.hidden_size
        per_expert_ff_dim = 4 * neox_args.hidden_size
    ...
    def forward(self, x: torch.Tensor):
        ...
        return gg.ops.gmm(x, w1, grouped_gemm_batch_sizes, trans_b=False)
