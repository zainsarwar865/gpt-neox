...
from megatron.model.adapter_generators import ParameterGenerator
from megatron.model.moe import ParallelGroupedMLP
...
class GPT2ModelPipe(PipelineModule, torch.nn.Module):
    ...
    def __init__(
        ...
        self.mlp = None
        #print("ID in None case is ", id(self.mlp))
        ...
        #print("ID in gpt_model is : ", id(self.mlp))
