...
from .moe_mlp import ParallelGroupedLLaMAMLP, ParallelGroupedMLP, ParallelBiasNetMLP
...
class ParallelDroplessMLP(torch.nn.Module):
    ...
    def __init__(
        ...
        if self.expert_embedding_mode:
            ...
            self.BiasNet = ParallelBiasNetMLP(
                neox_args=neox_args,
                init_method=init_method,
                output_layer_init_method=output_layer_init_method,
            )
    ...
    def permute_and_compute(
        ...
        expert_embeddings_idx = expert_embeddings[bin_ids]
        ...
        output_parallel = self.mlp(input_parallel, local_tokens_per_expert, bias_terms)
