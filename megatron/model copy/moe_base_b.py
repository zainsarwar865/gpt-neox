...
from .moe_mlp_base_b import ParallelGroupedLLaMAMLP, ParallelGroupedMLP
...
class ParallelDroplessMLP(torch.nn.Module):
    ...
    def permute_and_compute(
        ...
        # print("input", input_.device)
        # print("indices", indices.device, "bin_ids", bin_ids.device, "bins", bins.device, type(top_k))
