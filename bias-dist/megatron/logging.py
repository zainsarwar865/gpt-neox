...
def training_log(
    ...
    #     if k.endswith('experts.mlp'):
    #         tb_wandb_log(
    #             f'hn/{k}_contrib_x',
    #             v.lowrank_expert_norm_x,
    #             iteration,
    #             use_wandb=neox_args.use_wandb,
    #             tensorboard_writer=neox_args.tensorboard_writer,
    #         )
    #         v.lowrank_expert_norm_x = 0
    #         # hn_contrib_x[k] = temp_x
    #         # hn_contrib_y[k] = temp_y
    #         tb_wandb_log(
    #             f'hn/{k}_contrib_y',
    #             v.lowrank_expert_norm_y,
    #             iteration,
    #             use_wandb=neox_args.use_wandb,
    #             tensorboard_writer=neox_args.tensorboard_writer,
    #         )
    #         v.lowrank_expert_norm_y = 0
