...
class ParallelGroupedMLP(torch.nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        ...
        grouped_gemm_batch_sizes = torch.tensor([x.shape[0]]).to(torch.long)
...
class ParallelTransformerLayer(nn.Module):
    ...
    def __init__(
        ...
        # if branch == 'base-moe':
        #     from megatron.model.moe_base_b import ParallelDroplessMoE
        # elif branch == 'lora':
        #     from megatron.model.moe_lora import ParallelDroplessMoE
        # elif branch == 'hetro':
        #     from megatron.model.moe_hetro import ParallelDroplessMoE
        neox_args.mlp_layer_number = layer_number
    ...
    def forward(self, x, attention_mask, layer_past=None):
        ...
        if self.gpt_j_residual:
            ...
            with torch.enable_grad():
                ...
                if self.mlp_type == "llama" or self.num_experts > 0:
                    # No dropout either
