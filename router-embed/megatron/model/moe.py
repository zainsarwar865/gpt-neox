...
class ParallelDroplessMLP(torch.nn.Module):
    ...
    def permute_and_compute(
        ...
        # Get indexed router embeddings here
        expert_embeddings_idx = router.layer.weight[bin_ids]
    ...
    def forward(self, x, expert_weights, expert_indices, router):
        """
...
class ParallelDroplessMoE(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        return self.experts(x, expert_weights, expert_indices, self.router), None
