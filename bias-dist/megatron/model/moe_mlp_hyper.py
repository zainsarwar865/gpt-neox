...
class ParallelGroupedMLP(torch.nn.Module):
    ...
    def set_factorized_state(self):
        ...
        self.w1_factorization_u, self.w1_factorization_v = self.get_factorization(w1)
        self.w2_factorization_u, self.w2_factorization_v = self.get_factorization(w2)
        
    def factorize(self):
        if self.args.iteration % 1000 == 0:
