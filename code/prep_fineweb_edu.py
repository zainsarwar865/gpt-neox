...
# os.environ["HF_HOME"] = "/scratch/bdgs/zsarwar/huggingface_datasets"
# os.environ["HF_DATASETS_CACHE"] = "/scratch/bdgs/zsarwar/huggingface_datasets"

# # Configurations
# TOKEN_LIMIT = 12_000_000_000  # 12B total tokens
# BATCH_SIZE = 1_000_00000  # Write every 1M tokens
# OUTPUT_FILE = "/scratch/bdgs/zsarwar/datasets/raw/fineweb_edu_raw_12B.txt"
...
# # Configurations
# TOKEN_LIMIT = 2_000_000_000  # 1B total tokens
# SKIP_TOKENS = 12_000_000_000  # Skip first 12B tokens
# BATCH_SIZE = 10_000_0000  # Write every 10M tokens
# OUTPUT_FILE = "/scratch/bdgs/zsarwar/datasets/raw/fineweb_edu_raw_2B_val.txt"
# DATASET_NAME = "HuggingFaceFW/fineweb-edu"
# DATASET_SPLIT = "train"
